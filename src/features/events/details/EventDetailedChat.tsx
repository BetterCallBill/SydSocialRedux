...
import { ChatComment } from '../../../app/types/appEvent';
                        ...
                        .map(comment => (
                            <Comment key={comment.id}>
                                ...
                                <Comment.Content>
                                    ...
                                    <Comment.Actions>
                                        <Comment.Action onClick={() => setReplyForm({ open: true, commentId: comment.id })}>Reply</Comment.Action>
                                        {replyForm.open && replyForm.commentId === comment.id && (
                                            <ChatForm key={comment.id} eventId={eventId} parentId={comment.id} setReplyForm={setReplyForm} />
                                        )}
                                    </Comment.Actions>
                                </Comment.Content>
                                    ...
                                    {comment.childNodes.map(child => (
                                        <Comment key={child.id}>
                                            ...
                                            <Comment.Content>
                                                ...
                                                <Comment.Actions>
                                                    <Comment.Action onClick={() => setReplyForm({ open: true, commentId: child.id })}>
                                                        Reply
                                                    </Comment.Action>
