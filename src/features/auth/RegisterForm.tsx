        ...
        <ModalWrapper header="Register to re-vents">
            <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Form.Input
                    ...
                    error={(errors.email?.type === 'required' && 'Email is required') || (errors.email?.type === 'pattern' && 'Email is invalid')}
                />
                <Form.Input
                    type="password"
                    defaultValue=""
                ...
                />
                {errors.root && <Label basic color="red" style={{ display: 'block', marginBottom: 10 }} content={errors.root.serverError.message} />}
                <Button
